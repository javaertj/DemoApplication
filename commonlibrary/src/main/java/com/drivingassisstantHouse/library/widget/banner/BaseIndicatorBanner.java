...
import com.drivingassisstantHouse.library.widget.banner.anim.BaseAnimator;

import java.util.ArrayList;

/**
 * 调整了包结构，源码来源于 https://github.com/H07000223/FlycoBanner_Master
 * 广告banner指示器，配合广告条一起使用。可直接放置于scrollview中，已经处理了手势冲突的问题
 *
 * **/
public abstract class BaseIndicatorBanner<E, T extends BaseIndicatorBanner<E, T>> extends BaseBanner<E, T> {
    ...
    public BaseIndicatorBanner(Context context, AttributeSet attrs, int defStyle) {
        ...
        //createSpannableString indicator container
