...
import com.ykbjson.demo.app.DemoApplication;
...
public class ToolToast {
	...
	public static void showLong(String msg){
		buildToast(DemoApplication.getInstance(),msg,Toast.LENGTH_LONG).show();
	}
	...
	public static void showShort(String msg){
		buildToast(DemoApplication.getInstance(),msg,Toast.LENGTH_SHORT).show();
	}
